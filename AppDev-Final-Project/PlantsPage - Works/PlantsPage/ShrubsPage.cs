...
{
    public partial class ShrubsPage : Form
    {
        int _RecordIndex = 0;
        ...
        {
            string selectQuery = "SELECT * FROM Plant WHERE Type = 'Shrub'";
        ...
        private void prev_btn_Click(object sender, EventArgs e)
        {
            ...
            plantsPictureBox.Image = (Image)(Properties.Resources.ResourceManager.GetObject("shrub" + (_RecordIndex + 1)));
        }
